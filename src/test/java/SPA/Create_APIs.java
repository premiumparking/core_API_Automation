...
//		Query query = gson.fromJson(signin, Query.class);
//		
//
...
//			passStep(request_Payload);
//
//			Response resp = given().contentType("application/json").headers("source-auth-token", source_auth_token)
//					.header("x-auth-token", auth_token).body(request_Payload).when().post("/graphql");
//			stepInfo("Response Body");
...
//
//		Response resp = given().log().all().contentType("application/json")
//				.headers("source-auth-token", source_auth_token).header("x-auth-token", auth_token).body(spa_signOut)
//				.when().log().all().post("/graphql");
//		stepInfo("Response Body");
//		passStep(resp.asString());
//
//		stepInfo("Response Validation");
